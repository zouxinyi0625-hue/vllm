#!/usr/bin/env python3
"""Custom offline throughput driver for Qwen3.6-35B-A3B FP8.

Same structure as gemma4_moe_fp8/bench_offline.py — uses vllm.LLM directly
with real prompts and captures per-request stats.
"""
