#!/usr/bin/env python3
"""Single experiment executor for Qwen3.6-35B-A3B FP8 autobench.

Runs one vLLM offline benchmark with a given config JSON.
Aligned with gemma4_moe_fp8/autobench/run_experiment.py.

Usage:
    python run_experiment.py --config configs/baseline.json
    python run_experiment.py --config configs/baseline.json --dry-run
    python run_experiment.py --config configs/baseline.json --prompts 200 --reps 2
"""
...
def main():
    ap = argparse.ArgumentParser(description="Run single Qwen3.6 autobench experiment")
